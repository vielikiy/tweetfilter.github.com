...
// <debug>
    ...
    this._debugfunctions = ['refreshfriendscss'];//which functions to debug (whitelist). empty array = debug all functions
...
// </debug>   
    ...
    this.version = '2.1.1'; //current visible script version
