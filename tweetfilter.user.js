  ...
  Tweetfilter.prototype.setoption = function(option, status, clicked) {
    ...
    switch(option) {
      ...
      case 'filter-inverted': /* show only filtered*/
        if (clicked) window.scrollTo(0,0); //scroll to top when switching between timeline and filtered
        this.poll('setstreamtitle');
  ...
  Tweetfilter.prototype.createwidget = function() {
    ...
    if (!this.widget) {
      ...
      .delegate('a[data-option]', 'mousedown', function(e) {
        ...
        if (!sender.hasClass('disabled') && !sendersparent.hasClass('disabled')) {
      ...
      switch(name) {
        ...
        case 'layout':
         style = [
          ...
          'body.tf-hide-topbar div#top-bar-bg, body.tf-hide-topbar div#top-bar {  visibility:hidden;  }',
